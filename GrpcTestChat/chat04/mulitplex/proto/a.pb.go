...
func (*String) Descriptor() ([]byte, []int) {
	return fileDescriptor_a_1f1cc28a7a02a2dd, []int{0}
}
...
func (c *aClient) Echo(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/proto.A/Echo", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _A_Echo_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(String)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AServer).Echo(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.A/Echo",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AServer).Echo(ctx, req.(*String))
	}
...
func (m *String) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Str) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintA(dAtA, i, uint64(len(m.Str)))
		i += copy(dAtA[i:], m.Str)
	}
	return i, nil
}
...
func init() { proto.RegisterFile("a.proto", fileDescriptor_a_1f1cc28a7a02a2dd) }

var fileDescriptor_a_1f1cc28a7a02a2dd = []byte{
	// 118 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x62, 0x4f, 0xd4, 0x2b, 0x28,
	0xca, 0x2f, 0xc9, 0x17, 0x62, 0x05, 0x53, 0x4a, 0x52, 0x5c, 0x6c, 0xc1, 0x25, 0x45, 0x99, 0x79,
	0xe9, 0x42, 0x02, 0x5c, 0xcc, 0xc5, 0x25, 0x45, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x20,
	0xa6, 0x91, 0x26, 0x17, 0xa3, 0xa3, 0x90, 0x0a, 0x17, 0x8b, 0x6b, 0x72, 0x46, 0xbe, 0x10, 0x2f,
	0x44, 0x9f, 0x1e, 0x44, 0xb5, 0x14, 0x2a, 0xd7, 0x49, 0xe2, 0xc4, 0x23, 0x39, 0xc6, 0x0b, 0x8f,
	0xe4, 0x18, 0x1f, 0x3c, 0x92, 0x63, 0x9c, 0xf0, 0x58, 0x8e, 0xe1, 0xc2, 0x63, 0x39, 0x86, 0x1b,
	0x8f, 0xe5, 0x18, 0x92, 0xd8, 0xc0, 0xea, 0x8c, 0x01, 0x01, 0x00, 0x00, 0xff, 0xff, 0x96, 0x80,
	0x76, 0xac, 0x79, 0x00, 0x00, 0x00,
}
